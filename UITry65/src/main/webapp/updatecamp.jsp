...
<tr>
<th class="text-warning"> Campaign  Name</th>
 <th class="text-warning"> Campaign Location</th>
  <th class="text-warning"> Campaign Date</th>
         ...
         try{
           ...
           while(it.hasNext())
           {
        	   ...
        	   while(str.hasMoreTokens())
        	   {
        		    ...
        		    {
        		    	out.println("<td class=\"noBorder\">"+value+"</td>");
        		    	out.println("<td class=\"noBorder\"><a href='updatecamp1.jsp?cid="+x+"'>Update </a></td></tr>");
        		    }

...
<%
         try{
          ...
          Document query = new Document("uname", uname).append("passcode", passcode);
            ...
            if (user != null) {
                ...
                out.println("Sign-in successful. Welcome, " + uname + "!");

                // Redirect to another HTML page upon successful sign-in
          
                response.sendRedirect("aftersignin.jsp?uname=" + uname);
            } else {
            	out.println(uname);

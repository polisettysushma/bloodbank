...
<%
   try
   {
	...
	MongoCollection<Document>DPSlColl = db.getCollection("walkin22");

	Document filter = new Document("uname", uname); // Replace with your filter criteria

	// Define the update operation using $set
	Document update = new Document("$set", new Document("status", "Approved"));

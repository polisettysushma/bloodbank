...
try
{
	MongoClient mongo = new MongoClient("localhost", 27017);
	  ...
	  DBCollection collection = database.getCollection("walkin22");
...
%>
  ...
  <br><br><br>
<form action='walkin_register1.jsp'>

<br><br><br>
<div class="login-box">
  <h2>Fill the form to become a Donor</h2>
  <form>
    <div class="user-box">
    ...
    <label style="color:white;" for="birthday">Date of Birthday:</label>
    <br>
<input type="date" name="age" id="birthday" name="birthday" required="">
    <br><br>
    <div class="user-box">
    ...
    <div class="user-box">
     ...
     <select class="user-box"  name='gender' >

...
<th class="text-warning"> Donated Time</th>
<th class="text-warning"> Approvals</th>
<th class="text-warning"> Denies</th>
</tr>
           ...
           while(it.hasNext())
           {
        	   ...
        	   while(str.hasMoreTokens())
        	   {
        		    ...
        		    if(count==14)
        		    {
        		    	...
        		    	{
        		    	out.println("<td class=\"noBorder\"><a href='approvedonor1.jsp?uname="+x+"'>Approve </a></td>");
        		    	out.println("<td class=\"noBorder\"><a href='approvedonor2.jsp?uname="+x+"'>Deny </a></td></tr>");
        		    	}
        		    	else
        		    	{

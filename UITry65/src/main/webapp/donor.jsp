...
try
{
	MongoClient mongo = new MongoClient("localhost", 27017);
	  ...
	  DBCollection collection = database.getCollection("donors22");
...
%>
 ...
 <div class="wrapper">
    <div class="title">
      ...
      <input type='text' placeholder="Patient id"class="name field-in font" name='did' size=20 value=<%= did %> readonly>
      
     
      <input type='text' class="name field-in font" name='name' size=20 placeholder="Donar Name">

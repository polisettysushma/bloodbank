...
<meta charset="UTF-8">
 ...
 <head>
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="4;url="walkin.jsp">
...
<div class="login-box">
  <h2 style="color:cyan">Sorry,the user name is already taken</h2>
  <br>
  <h2 style="color:orange">You will be redirecting to Sign up Page(in 2 seconds)</h2>
  <br>
...
<%@ page import="java.util.*" %>
 ...
 <script type="text/javascript">
        setTimeout(function() {
            window.location.href = "walkin.jsp";

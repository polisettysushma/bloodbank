...
<meta charset="UTF-8">
 ...
 <head>
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="4;url="bloodcampdonor.jsp">
...
<div class="login-box">
  <h2 style="color:cyan">Thanks for Confirming a Slot</h2>
  <br>
  <h2 style="color:orange">You will be redirecting to Blood Camps  Page(in 2 seconds)</h2>
  <br>
  <h2 style="color:violet">Admin will approve and move forwards to nect Step</h2>
...
<%@ page import="java.util.*" %>
 ...
 <script type="text/javascript">
        setTimeout(function() {
            window.location.href = "bloodcampdonor.jsp";

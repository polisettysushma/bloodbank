...
<meta charset="UTF-8">
 ...
 <head>
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="4;url="walkin_login.jsp"">
...
<div class="login-box">
  <h2 style="color:blue">Thank you for being to a Donor</h2>
  <br>
  <h2 style="color:orange">You will be redirecting to Sign in Page(in 2 seconds)</h2>
  <br>
  <h2 style="color:violet">Please Sign in and confirm your slot</h2>
...
<%@ page import="java.util.*" %>
 ...
 <script type="text/javascript">
        setTimeout(function() {
            window.location.href = "walkin_login.jsp";

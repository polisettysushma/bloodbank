...
<tr>
<th class="text-dark"> Donor appoint id</th>
<th class="text-dark"> Donor Id</th>
<th class="text-dark"> Hospital Id</th>
<th class="text-dark"> Appoint Date</th>
...
<%
         try{
             ...
             MongoCollection<Document> collection = database.getCollection("Donor appointment");
           ...
           out.println("<td class=\"text-success\"><a href='view_dstatus1.jsp?t1="+x+"'>Update</a></td></tr>");

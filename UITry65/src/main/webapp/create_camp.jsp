...
try
{
	MongoClient mongo = new MongoClient("localhost", 27017);
	  ...
	  DBCollection collection = database.getCollection("camp");
...
<div class="login-box">
  <h2>Campaign Registration</h2>
       ...
       <div class="user-box">
      <input type="text" name="cid" required="" value= <%= hid %> readonly class="hidden-input">
    </div>
    ...
    <div class="user-box">
     ...
     <div class="user-box">
    <text style="color: orange;">Start Time</text>
      <input type="time" name="stime" required="">
      
    </div>
    
     <div class="user-box">
    <text style="color: orange;">End Time</text>
      <input type="time" name="etime" required="">
      
    </div>
    
 <div class="user-box">
    <text style="color: orange;">Campaign Date</text>
     ...
     <br><br><br>
      <input class="submit font" type='submit' value='Create'>

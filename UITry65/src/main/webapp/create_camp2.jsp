...
database.getCollection("camp");
//database.createCollection("donor2");
//Preparing a document
Document document = new Document();
document.append("cid", cid);
document.append("cname", cname);
document.append("clocation", clocation);
document.append("cdate", cdate);
document.append("stime", stime);
document.append("etime", etime);

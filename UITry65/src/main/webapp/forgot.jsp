...
<form action='walkin.jsp'>



<div class="login-box">
  <h2 style="color:green">Update password</h2>
  <form>
    <div class="user-box">
    ...
    <div class="user-box">
      <input type="number" name="passcode" required="">
      <label>Contact</label>
    </div>
   
     <br>
      <input class="submit font" type='submit' value='Send Code'>

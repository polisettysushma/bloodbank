...
<div class="login-box">
  <h2>Update Campaign </h2>
       ...
       <div class="user-box">
      <input type="text" name="cid" required="" value= <%= cid2 %> readonly>
    </div>
    ...
    <div class="user-box">
      ...
      <label>Updated Campaign Location</label>
    </div>
 ...
 <div class="user-box">
    <text style="color: orange;">Campaign Date</text>
      ...
      <select class="user-box"  name='cstatus' >

...
<%
         try{
            ...
            MongoCollection<Document> collection = database.getCollection("centri");
           ...
           while(it.hasNext())
           {
        	  ...
        	  out.println(" <main class='cards'>");
        	   ...
        	   while(str.hasMoreTokens())
        	   {
					...
					if(count==2)
						out.println("<h1 style='color: glod;'>"+value+"</h2>");
        		    if(count==3)
						out.println("<h2 style='color: orange;'>Name: "+value+"</h2>");
        		    if(count==4)
        		    	out.println("<h3 style='color: green;'>Location : "+value+"</h3>");
        		    if(count==5)
        		    	out.println("<h3 style='color: cyan;'> Blood Group : "+value+"</h4>");
        		    out.println("<br>");
        		    if(count==6)
        		    	out.println("<h5>Blood Qty(Ml) : "+value+" ml</p>");
        		    
        		    if(count==7)
        		    	out.println("<h4 style='color: yellow;'> Time : "+value+"</h4>");

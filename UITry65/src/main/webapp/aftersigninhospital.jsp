...
<%@ page import="java.util.*" %>
    <form action='hospital_request.jsp'>
<%
int hid=300;
try
{
	MongoClient mongo = new MongoClient("localhost", 27017);
	  ...
	  DBCollection collection = database.getCollection("hospitalrequests");
...
<div class="login-box">
  <h2 style="color:green">Blood Group Request</h2>
  <form>
  
  <div class="user-box">
     <label>Req Id</label>
     <br>
      <input type="text" name="hid" required="" value=<%=hid %> readonly>
    ...
    <div class="user-box">
     ...
     <br>
      <input type="text" name="hname" required="" value=<%=hname %> readonly>
      ...
      <option>Required Blood Group</option>
		...
		<select class="user-box"  name='prio' >
	 ...
	 <br> <br>
		<select class="user-box"  name='qty' >
     ...
     <br> <br>
      <input class="submit font" type='submit' value='Send Request'> &nbsp;&nbsp;&nbsp;
      
     <a style="color: black" class="submit font" href="checkhospitalreq.jsp?hname=<%= hname %>">Check Status</a>

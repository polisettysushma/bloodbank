...
<tr><tr>
<th  class="text-warning"> Patient name</th>
<th class="text-warning"> Patient Age </th>
<th class="text-warning"> Patient Gender</th>
<th class="text-warning"> Patient Blood group</th>
<th class="text-warning"> Patient State</th>
<th class="text-warning"> Patient City</th>
<th class="text-warning"> Patient Phno</th>
 <th class="text-warning"> Patient pid</th>
</tr>
...
<%
         try{
            ...
            MongoCollection<Document> collection = database.getCollection("patient22");

...
<form action='Centrifugation1.jsp'>
...
try
{
	MongoClient mongo = new MongoClient("localhost", 27017);
	  ...
	  DBCollection collection = database.getCollection("centrifugation");
...
%>      	 
 ...
 <input placeholder="Plasma Bagno Id"class="name field-in font" type='text' name='plasma bagno' value='<%= bagno %>' readonly size=20> 
...
%>
 ...
 <input class="name field-in font" type='date' name='date' size=20> 
   
   
   
   
	 
	 <input class="name field-in font" type='number' placeholder="Voulme in ml" name='volume' size=20> 
